# -*- coding: utf-8 -*-
'''Django settings for Know Your Representative project.
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'kyr.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    "EXCEPTION_HANDLER": "kyr.base.exceptions.exception_handler",
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
